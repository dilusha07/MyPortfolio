      ...
      >
        <div className="w-full lgl:w-1/2">
          <div className="py-12 font-titleFont flex flex-col gap-4">
            ...
            <h2 className="text-3xl md:text-4xl font-bold">Progamming Skill</h2>
          </div>
          <div className='className="mt-14 w-full flex flex-col gap-6'>
            <div className="overflow-x-hidden">
              <p className="text-sm uppercase font-medium"> HTML, CSS, SCSS</p>
            ...
            <div className="overflow-x-hidden">
              <p className="text-sm uppercase font-medium">JavaScript, TypeScript, ES6</p>
              <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
                <motion.span
                  initial={{ x: "-100%", opacity: 0 }}
                  animate={{ x: 0, opacity: 1 }}
            ...
            <div className="overflow-x-hidden">
              <p className="text-sm uppercase font-medium">Java, SpringBoot, MicroServices</p>
              <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
                <motion.span
                  initial={{ x: "-100%", opacity: 0 }}
                  animate={{ x: 0, opacity: 1 }}
            ...
            <div className="overflow-x-hidden">
              <p className="text-sm uppercase font-medium">Angular 12+</p>
              <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
                <motion.span
                  initial={{ x: "-100%", opacity: 0 }}
                  animate={{ x: 0, opacity: 1 }}
        ...
        <div className="w-full lgl:w-1/2">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="overflow-x-hidden">
              <p className="text-sm uppercase font-medium">AWS, Firebase, Docker</p>
              <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
                <motion.span
                  initial={{ x: "-100%", opacity: 0 }}
                  animate={{ x: 0, opacity: 1 }}
            ...
            <div className="overflow-x-hidden">
              <p className="text-sm uppercase font-medium">JQUery,Bootstrap</p>
              <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
                <motion.span
                  initial={{ x: "-100%", opacity: 0 }}
                  animate={{ x: 0, opacity: 1 }}
